...
public class NeuronLayer {
    ...
    private ArrayList<Neurons> arrayPerceptrons = new ArrayList<>();
    private ArrayList<ArrayList<Double>> arrayWeights = new ArrayList<>();

    //private int numGroup;
    public NeuronLayer(int numIn, int numOut, ArrayList inputs,
    ...
    public void generateNextInput() {
        ...
        for (int i = 0; i < numOut; i++) {
            Neurons a = new Neurons(this.inputs, this.numIn,
    ...
    public void update(ArrayList<ArrayList<Double>> arrayWeights) {
        ...
        for (Neurons e : this.arrayPerceptrons) {
